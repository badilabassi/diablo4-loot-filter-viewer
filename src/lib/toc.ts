// Shared data types and processing — usable in browser, Node, and seed scripts.

import type { AffixCategory } from "./schemas";
...
export interface TocData {
  ...
  items: TocItem[];
  ts: number;
  /** SHA of the GitHub commit this data was built from, used for cache invalidation. */
  commitHash?: string;
  /** ETag or Last-Modified of the Maxroll data file, used for cache invalidation. */
  maxrollEtag?: string;
}
