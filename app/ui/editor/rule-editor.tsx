      ...
      return (
        ...
        >
          ...
          >
            <div mix={[css({ display: 'flex', flexDirection: 'column', gap: '2px' })]}>
              <button
                type="button"
                disabled={i === 0}
                mix={[css({ border: 0, background: 'transparent', cursor: 'pointer', fontSize: '10px' }), on('click', () => {
            ...
            <span style={{ fontSize: '12px', color: 'var(--d4-text3)', width: '20px', textAlign: 'center' }}>
              {i + 1}
            </span>
            <input
              type="text"
            ...
            <label mix={[css({ position: 'relative', width: '20px', height: '20px' })]}>
              <span
                mix={[css({ display: 'block', width: '100%', height: '100%', borderRadius: '4px', border: '1px solid var(--d4-border)' })]}
            ...
            <button
              type="button"
              mix={[css({ border: 0, background: 'transparent', cursor: 'pointer', color: 'var(--d4-text3)' }), on('click', () => {
          ...
          >
            ...
            <button
              type="button"
              mix={[css({ border: 0, background: 'transparent', fontSize: '12px', color: 'var(--d4-text3)', cursor: 'pointer' }), on('click', () => {
